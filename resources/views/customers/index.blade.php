                        ...
                        <div class="relative">
                            ...
                            >
                                <path
                                    ...
                                    stroke-width="2"
                                    d="M11 19a8 8 0 110-16 8 8 0 010 16zm0 0l4 4m-4-4l-4-4"
                                ></path>
                            </svg>
                        </div>
                ...
                <div class="flex flex-col items-center md:flex-row">
                    ...
                    <div class="relative mt-8 md:w-1/2 md:mt-0">
                        <div class="relative z-10">
                            <img
                                src="https://cdn.hoanghamobile.com/i/content/Uploads/2023/12/14/iphone-15-pro-max-natural-titanium-1-hhm.jpg"
                                alt="Latest Phones"
                                class="rounded-lg shadow-2xl w-200px h-200px"
                            />
                            <div
                                class="absolute p-4 bg-white rounded-lg shadow-lg -bottom-4 -right-4"
                            >
        ...
        <section class="container px-6 py-12 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    <div class="relative">
                        <img
                            src="https://product.hstatic.net/200000409445/product/3_95c54066ba184e7b971052f3ad2b5bc6_master.jpg"
        ...
        <section class="py-16 bg-gray-50">
            <div class="container px-6 mx-auto">
                ...
                >
                    <!-- Feature 1 -->
                    <div
                        class="p-6 transition-shadow bg-white shadow-lg rounded-xl hover:shadow-xl"
                    >
                        <div
                            class="flex items-center justify-center mb-6 bg-blue-100 rounded-full w-14 h-14"
                        >
                            <svg
                    ...
                    >
                        <div
                            class="flex items-center justify-center mb-6 bg-green-100 rounded-full w-14 h-14"
                        >
                            <svg
                        ...
                        <div class="mt-4">
                            <a
                                href="#"
                                class="inline-flex items-center font-medium text-green-600 hover:text-green-800"
                            >
                                Xem chính sách
                                <svg
                                    class="w-4 h-4 ml-2"
                    ...
                    >
                        <div
                            class="flex items-center justify-center mb-6 bg-purple-100 rounded-full w-14 h-14"
                        >
                            <svg
                        ...
                        <div class="mt-4">
                            <a
                                href="#"
                                class="inline-flex items-center font-medium text-purple-600 hover:text-purple-800"
                            >
                                Xem hướng dẫn
                                <svg
                                    class="w-4 h-4 ml-2"
                    ...
                    >
                        <div
                            class="flex items-center justify-center mb-6 bg-red-100 rounded-full w-14 h-14"
                        >
                            <svg
                        ...
                        <div class="mt-4">
                            <a
                                href="#"
                                class="inline-flex items-center font-medium text-red-600 hover:text-red-800"
                            >
                                Liên hệ ngay
                                <svg
                                    class="w-4 h-4 ml-2"
        ...
        <section class="py-16 bg-white">
            <div class="container px-6 mx-auto">
                ...
                >
                    ...
                    >
                        <img
                            class="object-cover w-full h-56 mb-4 rounded-lg"
            ...
            <div class="container px-6 mx-auto text-center">
                ...
                >
                    <input
                        ...
                        class="p-3 text-gray-700 rounded-l-lg w-80"
                        required
                    />
                    <button
                        type="submit"
                        class="p-3 text-white bg-blue-600 rounded-r-lg hover:bg-blue-700"
                    >
                        Đăng ký
                    </button>
                </form>
        ...
        <footer class="text-gray-300 bg-gray-900">
            ...
            <div class="border-b border-gray-800">
                <div class="container px-4 py-12 mx-auto">
                    <div
                        class="grid items-center grid-cols-1 gap-8 md:grid-cols-2"
                    >
                        <div>
            ...
            <div class="container px-4 py-12 mx-auto">
                <div
                    class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4"
                >
                    <!-- Company Info -->
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-400"
                                    >123 Nguyễn Văn Linh, Quận 7, TP.HCM</span
                                >
                            </li>
