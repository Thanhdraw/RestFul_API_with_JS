<nav x-data="{ open: false }" class="border-b border-gray-100 dark:bg-gray-500 dark:bg-gray-800 dark:border-gray-500">
    <!-- Primary Navigation Menu -->
    <div class="px-4 mx-auto text-gray-800 max-w-7xl sm:px-6 lg:px-8 dark:text-gray-200">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block w-auto text-black text-gray-800 fill-current h-9 dark:text-gray-200" />
                    </a>
                </div>
