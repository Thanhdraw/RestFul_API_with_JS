<section>
    <header>
        <h2 class="text-lg font-medium text-gray-500 dark:text-gray-600">
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                <p
                    ...
                    class="text-sm text-gray-900 dark:text-gray-600"
                ><?php echo e(__('Saved.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH /Applications/AMPPS/www/laravel/ecommerce/resources/views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>