<nav x-data="{ open: false }" class="dark:bg-gray-500  dark:bg-gray-800 border-b border-gray-100 dark:border-gray-500">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800 dark:text-gray-200">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'block text-black h-9 w-auto fill-current text-gray-800 dark:text-gray-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block text-black h-9 w-auto fill-current text-gray-800 dark:text-gray-200']); ?>
...
<?php endif; ?>
                ...
                <!-- Navigation Links -->
                <div class="hidden text-black space-x-8 sm:-my-px sm:ms-10 sm:flex">
...
<?php endif; ?>
            ...
            <!-- Settings Dropdown -->
            <div class="hidden text-black hover:text-gray-500 sm:flex sm:items-center sm:ms-6">
...
<?php /**PATH /Applications/AMPPS/www/laravel/ecommerce/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>